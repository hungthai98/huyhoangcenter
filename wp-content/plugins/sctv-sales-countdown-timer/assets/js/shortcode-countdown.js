...
function sctv_run_countdown(type = '', time = 0) {
    ...
    let wooCountdown = jQuery('.woo-sctr-shortcode-countdown-timer-wrap'),
        time_end_parent = jQuery('.woo-sctr-shortcode-countdown-timer-wrap .woo-sctr-countdown-end-time');
    ...
    vi_sctr_x = setInterval(function () {
        wooCountdown.each(function (i,countdown_wrap) {
            ...
            if (distance[i] < 0) {
                clearInterval(vi_sctr_x);
                if (jQuery(countdown_wrap).hasClass('woo-sctr-shortcode-countdown-timer-wrap-event')) {
...
function sctv_run_countdown1(type = '', time = 0) {
